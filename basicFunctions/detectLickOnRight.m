function [lickFlag relLickTime] = detectLickOnRight (lickSenseDuration, niCardSession)


%This function detects thelick on the right spout (one spout monitoring for go/noGo task) through the output of the Janelia lick
